...
export default function OrderDetail() {
  ...
  const KPI = ({ label, value, sub }) => (
    <div style={{
      background: "#0f1630", border:"1px solid var(--border)", borderRadius:12,
      padding:14, display:"grid", gap:4
    }}>
          ...
          <div className="panel" style={{padding:16}}>
            ...
            <div style={{display:"grid",gap:12}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginTop:6}}>
                <div className="badge high" style={{display:"inline-block",textAlign:"center"}}>Sustainability: {order.sustainabilityScore}%</div>
                <div className="badge medium" style={{display:"inline-block",textAlign:"center"}}>Digital Maturity: {order.digitalMaturity}%</div>
              </div>
            </div>
          </div>
        </div>
